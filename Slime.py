        ...
        for guyimfighting in monsters:
            ...
            if guyimfighting.hp > 0:
                ...
                if guyimfighting.Dex - character.Dex <=0:
                    print(character.name, "attacks for :",  True_damage + (character.Strength / 2))

                #print(F"{classselection.user_type} attacks for : {classselection.real_user_damage}")
                guyimfighting.hp = guyimfighting.hp - (True_damage + character.Strength / 2)

                # this is the line where you choose to run and loose the fight

                if user_action == 'run' or user_action == 'Run' or user_action == 'RUN' or user_action == '3':
                    print("you have decided to live another day, sadly you must start anew")
                    break
