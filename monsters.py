...
class monster_class:
    ...
    typelist = ["slime", "dragon", "skeleton", "werewolf",
                "wyvern", "bandit", "ogre", "chimera", "minotaur"]
    exp = 0
...
slime = monster_class(40, 2, 1, 1, 1, 1, 1, 0,
                      random.randint(1, 5), random.randint(1, 5))
black_dragon = monster_class(600, 50, 10, 10, 10, 10, 10, 1, random.randint(
    200, 1000), random.randint(200, 1000))
skeleton = monster_class(20, 3, 1, 1, 1, 1, 1, 2,
                         random.randint(2, 6), random.randint(1, 5))
werewolf = monster_class(125, 10, 1, 1, 1, 1, 1, 3,
                         random.randint(10, 30), random.randint(1, 5))
wyvern = monster_class(200, 20, 1, 1, 1, 1, 1, 4,
                       random.randint(25, 100), random.randint(1, 5))
bandit = monster_class(30, 10, 8, 5, 6, 4, 5, 5,
                       random.randint(10, 20), random.randint(10, 20))
ogre = monster_class(150, 20, 4, 2, 3, 4, 6, 6,
                     random.randint(20, 50), random.randint(20, 30))
chimera = monster_class(400, 30, 10, 10, 10, 10, 4, 7,
                        random.randint(30, 100), random.randint(30, 100))
minotaur = monster_class(220, 15, 5, 5, 5, 4, 4, 8,
